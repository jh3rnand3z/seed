...
fun.strings = {
    ...
    powerComCamColIntAndS: "Powerful features to make communication campaigns more collaborative, intelligente and simple",
    ...
    planFutureDiscussionTools: "Review changes, comment on lines of code, report issues, and plan the future of your project with discussion tools",
    matchCallersandTeams: "Match callers and custom teams as they wait for an answer, get real-time stats on the number of calls per queues, teams and wait times",
